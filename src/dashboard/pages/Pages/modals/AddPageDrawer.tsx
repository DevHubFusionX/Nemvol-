...
export default function AddPageDrawer({ open, onClose, onAdd }: Props) {
  ...
  const handleSubmit = () => {
    ...
    setErrors({});
    onAdd({ label: form.title, slug: form.slug, type: 'Custom Page', status: form.status });
    setDone(true);
  };
                ...
                {done ? (
                  ...
                  >
                    ...
                    <p className="text-[13px] text-slate-400 max-w-xs leading-relaxed">
                      ...
                      added to your storefront pages.
                    </p>
                  </motion.div>
                ) : (
                  <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-5">
                    <div>
                      ...
                      <p className="text-[12px] text-slate-400 mt-0.5">
                        Create a custom page for your storefront.
                      </p>
                    </div>
                    ...
                    <div className="rounded-xl border border-slate-100 p-4 space-y-3">
                      ...
                      <div>
                        <div className="flex items-center rounded-xl border border-slate-200 overflow-hidden focus-within:border-slate-400 transition-colors">
                          <span className="px-3 py-2.5 text-[13px] text-slate-400 bg-slate-50 border-r border-slate-200 shrink-0">
                            /pages/
                          </span>
                          <input
                            type="text"
