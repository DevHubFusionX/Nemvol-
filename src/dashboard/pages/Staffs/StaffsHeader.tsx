...
export default function StaffsHeader() {
  return (
    <div className="flex items-start justify-between">
      ...
      <button className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-slate-900 text-white text-[13px] font-semibold hover:bg-slate-700 transition-colors shrink-0">
