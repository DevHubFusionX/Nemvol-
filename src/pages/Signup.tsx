          ...
          {verifying ? (
            ...
            <>
              ...
              <p className="mt-2 text-[13px] text-slate-400">
                ...
                <span className="text-slate-700 font-semibold">{form.email}</span>
              </p>

              <form onSubmit={handleVerify} className="mt-10 flex flex-col gap-5">
                ...
                <button
                  ...
                  className="mt-2 inline-flex items-center justify-center gap-2 w-full px-6 py-3.5 rounded-xl bg-[var(--color-brand-blue)] hover:bg-[var(--color-brand-blue-hover)] text-white text-[13px] font-bold transition-all duration-200 active:scale-[0.98] disabled:opacity-60"
                >
                ...
                <button
                  ...
                  className="text-[12px] text-slate-400 hover:text-slate-600 transition-colors text-center"
                >
                  ← Back
                </button>
              </form>
